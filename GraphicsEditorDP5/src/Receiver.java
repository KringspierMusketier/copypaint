...
public class Receiver {
	...
	private ShapeLeaf selectRect = new ShapeLeaf(-1, -1, 1, 1, ShapeType.RECTANGLE.getStrategy(), SELECT_COLOR);
	private ShapeLeaf expandRect = new ShapeLeaf(-1, -1, EXPAND_RECT_SIZE, EXPAND_RECT_SIZE, ShapeType.RECTANGLE.getStrategy(), EXPAND_RECT_COLOR); 
